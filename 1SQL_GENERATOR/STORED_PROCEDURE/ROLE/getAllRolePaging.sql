...
-- =============================================
alter PROCEDURE [dbo].[Get_User_All_Paging] 
@keyword varchar(50),
@pageIndex int,
@pageSize int,
@totalRow int output
...
BEGIN
  ...
  FROM AspNetUsers
  Where FullName like @keyword + '%' or @keyword is null or UserName like @keyword + '%'

  SELECT  u.Id, u.UserName, u.Email,u.PhoneNumber, u.FullName, u.Address FROM AspNetUsers u
  Where u.FullName like @keyword+'%' or @keyword is null or UserName like @keyword + '%'
  ORDER BY u.FullName 
